...
/**
 * Caixa onde escolhe os produtos de limpeza 
 * 
...
public class TCaixa extends JInternalFrame {
	...
	public TCaixa(JDesktopPane desktopPane, String caminho, String operador, String acesso) {
		...
		pnl1.setBorder(new TitledBorder(null, "Produtos de Limpeza Casa e Banheiro", TitledBorder.LEADING, TitledBorder.TOP,
				null, null));
				...
				public void actionPerformed(ActionEvent arg0) {
					new Thread(new Runnable() {
						public void run() {
							...
							boolean cor = a.corButton(caminho, Banheiro);
							if (cor == false) {
								btn_.setBackground(Color.LIGHT_GRAY);
							} else {
								btn_.setBackground(Color.GRAY);
							}
							boolean aux = p.produto(caminho, Banheiro, quantidade);
							if (aux == true) {
								String linha = c.linha(caminho, quantidade, Banheiro,
										Integer.toString(lista.size() + 1));
								p.alterarEstoque(caminho, Banheiro, quantidade);
								lista.add(linha + "\n");
		...
		txtPedido.append("                        Sonho Verde - Produtos de Limpeza\n\n\n" + linha + "\n\n");
		...
		lblOperador.setBackground(new Color(0, 51, 0));
		lblOperador.setBounds(1134, 40, 187, 38);
		...
		pnl2.setBorder(
				new TitledBorder(null, "Produtos de Limpeza Cozinha e Roupas", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		panel_1.setBounds(1067, 83, 310, 412);
		panel.add(panel_1);
		...
		btn1.setBackground(new Color(0, 51, 0));
		...
		btn2.setBackground(new Color(0, 51, 0));
		...
		btn3.setBackground(new Color(0, 51, 0));
		...
		btn4.setBackground(new Color(0, 51, 0));
		...
		btn5.setBackground(new Color(0, 51, 0));
		...
		btn6.setBackground(new Color(0, 51, 0));
		...
		btn7.setBackground(new Color(0, 51, 0));
		...
		btn8.setBackground(new Color(0, 51, 0));
		...
		btn9.setBackground(new Color(0, 51, 0));
		...
		btn0.setBackground(new Color(0, 51, 0));
		...
		btnX.setBackground(new Color(0, 51, 0));

		txtQuantidade = new JTextField();
		txtQuantidade.setBounds(31, 359, 247, 43);
		...
		panel_2.setBounds(1067, 505, 310, 425);
		panel.add(panel_2);
		...
		btnFinalizar.setBounds(27, 32, 250, 58);
		...
		btnCancelarItem.setBounds(27, 100, 250, 58);
		...
		btnCancelarItem.setBackground(new Color(0, 51, 0));

		JButton btnCancelarVenda = new JButton("Cancelar Venda");
		btnCancelarVenda.setBounds(27, 168, 250, 58);
		...
		btnCancelarVenda.setBackground(new Color(0, 51, 0));

		JButton btnLogin = new JButton("Menu");
		btnLogin.setBounds(27, 236, 250, 51);
