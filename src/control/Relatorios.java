...
/**
 * Relatórios com o valor total de todas as compras feitas no dia, solicitação de nota fiscal específica e arquivo de notas fiscais 
 * 
...
public class Relatorios {
	...
	public String vendaPeriodo(String caminho, String dataInicial, String dataFinal, boolean a) {
		...
		String linha = "Total Dinheiro   : " + s.format(dinheiro) + "@" + "Total Débito     : " + s.format(debito) + "@"
				...
				+ "@" + "Total do Periodo : " + s.format(total);
		return linha;
	}
